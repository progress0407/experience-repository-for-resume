...
import io.philo.gateway.GatewayAppTest.TestRoute as Route_
...
class GatewayAppTest {
    ...
    fun `route 목록을 검증한다`() {
        ...
        routes["ITEM-SERVICE"] shouldBe_ Route_("/item", listOf(GET, POST), GlobalLoggingFilter::class)
